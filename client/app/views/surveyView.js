define(["survey-jquery", "jquery", "table_template"], function (
    ...
    return function () {
      ...
      if (
        !("survey" in table_template) ||
        Object.keys(table_template.survey).length === 0
      ) {
        return;
      }
      ...
      var json = {
          ...
          "pages": [
            ...
            "elements": [
             {
              "type": "multipletext",
              "name": "question0",
              "title": "Approximately how long have you been working in the art museum field?",
              "defaultValue": {
               "months": 0,
               "years": 0
              },
                ...
                "validators": [
                 {
                  ...
                  "expression": "{question0.months} <= 11 and {question0.months} >= 0"
                 }
                ]
               }
              ],
             ...
             },
             {
              "type": "multipletext",
              "name": "question1",
              "title": "And how long have you been working at your current museum (this could be the same as the previous question)?",
              "defaultValue": {
               "months": 0,
               "years": 0
              },
                ...
                "validators": [
                 {
                  "type": "expression",
                  "text": "Months must be between 0 and 11",
                  "expression": "{question1.months} <= 11 and {question1.months} >= 0"
                 }
                ]
               }
              ],
             ...
             },
             {
              "type": "radiogroup",
              "name": "question2",
              "title": "Which of the following best describes your current position level in the museum?",
              "isRequired": true,
              "choices": [
               {
                "value": "1",
           ...
           },
           {
            ...
            "elements": [
             ...
             },
             {
              "type": "checkbox",
              "name": "question4",
              "title": "Which of the following categories does your current museum position fall into? Pleaseselect ALL that apply.",
              "isRequired": true,
              "choices": [
               {
                "value": "1",
              ...
              "elements": [
               {
                "type": "text",
                "name": "question6",
                "title": "What is your approximate gross annual income (before taxes and deductions) from your current position in the museum? (If this changes from month to month, please provide an average). Report only your income from your museum job.",
                "isRequired": true,
                "inputType": "number",
                "min": 0,
                "step": 1000
               },
               {
                ...
                "elements": [
                 {
                  "type": "radiogroup",
                  "name": "question7",
                  "title": "Compared to people at similar position levels (e.g., entry level, associate, manager,executive) in my institution, I think my salary is:",
                  "isRequired": true,
                  "choices": [
                   {
                    "value": "1",
                 ...
                 },
                 {
                  "type": "radiogroup",
                  "name": "question8",
                  "title": "Compared to people at similar institutions with comparable position levels, I think mysalary is:",
                  "isRequired": true,
                  "choices": [
                   {
                    "value": "1",
                ...
                "title": "Next, we have a few questions about how you think about your salary relative to others in your institution and across the field. If you feel unsure about how much others make, please make your best guess."
               },
               {
                "type": "panel",
                "name": "panel3",
                "elements": [
                 {
                  ...
                  "title": "Have you ever received a promotion (with title change and pay increase beyond cost of living) during your tenure in your current museum?",
                  "isRequired": true,
                  "choices": [
                   {
                    "value": "1",
                 ...
                 },
                 {
                  ...
                  "title": "How many times have you received a promotion (with title change and payincrease beyond cost of living) during your tenure in your current museum?",
                  "isRequired": true,
                  "choices": [
                   "1",
                   "2",
                 ...
                 },
                 {
                  "type": "radiogroup",
                  "name": "question11",
                  "title": "How well does your current compensation from the museum cover your living expenses(e.g., rent, utilities, food, childcare)? My salary is …",
                  "isRequired": true,
                  "choices": [
                   {
                    "value": "1",
                 ...
                 },
                 {
                  "type": "checkbox",
                  "name": "question12",
                  "title": "Which of the following statements best reflect what work will look like for you based onthe museum’s post-Covid return-to-work plans? Please select ALL that apply.",
                  "isRequired": true,
                  "choices": [
                   {
                    "value": "1",
                ...
                "title": "We have just a few more questions about salary and promotions at your institution."
               }
              ],
            ...
            "elements": [
             {
              ...
              "name": "question13",
              "minWidth": "400px",
              "title": "Please rate how much you agree or disagree with the following statements in relation to the culture of your current museum workplace.",
              "isRequired": true,
              "showHeader": false,
              "verticalAlign": "top",
              "alternateRows": true,
            ...
            "elements": [
             {
              "type": "checkbox",
              "name": "question14",
              "title": "Which of the following statements best reflect the salary sharing practices of your museum workplace? Select all that apply.",
              "isRequired": true,
              "choices": [
               {
                "value": "1",
             ...
             },
             {
              "type": "checkbox",
              "name": "question15",
              "title": "In the past 12 months, have you experienced any of the following in your museum workplace? Please select all that apply.",
              "isRequired": true,
              "choices": [
               {
                "value": "1",
            ...
            "elements": [
             {
              "type": "radiogroup",
              "name": "question16",
              "title": "Have you ever considered leaving your current museum workplace?",
              "isRequired": true,
              "choices": [
               {
                "value": "1",
             ...
             },
             {
              ...
              "title": "Which of the following reasons made you consider leaving your current museum workplace? Please select ALL that apply.",
              "isRequired": true,
              "choices": [
               {
                "value": "1",
           ...
           },
           {
            ...
            "elements": [
             ...
             },
             {
              ...
              "title": "Which of the following reasons made you consider leaving the art museum field? Please select ALL that apply.",
              "isRequired": true,
              "choices": [
               {
                "value": "1",
            ...
            "elements": [
             {
              "type": "radiogroup",
              "name": "question20",
              "title": "Have you felt discriminated against or harassed (e.g., due to your gender, sexual orientation, racial or ethnic background, social or economic status, age, disability…) while working in your current museum workplace?",
              "isRequired": true,
              "choices": [
               {
                "value": "1",
             ...
             },
             {
              ...
              "title": "How often have you felt discriminated against and/or harassed while working in your current museum workplace?",
              "isRequired": true,
              "choices": [
               {
                "value": "1",
             ...
             },
             {
              ...
              "name": "question22",
              "visibleIf": "{question20} = 1",
              "title": "Which of the following forms of discrimination and/or harassment, have you experienced in your current museum workplace? Please select ALL that apply.",
              "isRequired": true,
              "choices": [
               {
                "value": "1",
             ...
             },
             {
              ...
              "name": "question23",
              "visibleIf": "{question20} = 1",
              "title": "Have you taken any of the following actions in response to discrimination and/or harassment in your current museum workplace? Please select ALL that apply.",
              "isRequired": true,
              "choices": [
               {
                "value": "1",
             ...
             },
             {
              ...
              "title": "What was your reason for not taking any action in response to the discrimination and harassment you experienced? Please select ALL that apply.",
              "isRequired": true,
              "choices": [
               {
                "value": "1",
            ...
            "elements": [
             {
              "type": "radiogroup",
              "name": "question25",
              "title": "Think about your past 12 months in your workplace (or the timeframe you have worked in your workplace if less than 12 months). Which of the following emotions best describe how you feel about working in your place, overall? Please select the emotion you most associate with working in your workplace.",
              "isRequired": true,
              "choices": [
               {
                "value": "1",
             ...
             },
             {
              "type": "checkbox",
              "name": "question26",
              "title": "What kind of role, if any, do you have in your museum’s diversity, equity, and inclusion efforts? Please select ALL that apply.",
              "isRequired": true,
              "choices": [
               {
                "value": "1",
           ...
           },
           {
            ...
            "description": "In this section, we will ask you some personal questions about who you are. We are asking these questions to make sure a diverse group of people participate in this survey. As a reminder, your responses to this survey, including personal information, will be kept anonymous. "
           },
           {
            "name": "page11",
            "elements": [
             {
              "type": "checkbox",
              "name": "question30",
              "title": "With which of the following racial and ethnic groups do you identify as? Please select all that apply.",
              "isRequired": true,
              "choices": [
               {
                "value": "1",
             ...
             },
             {
              "type": "radiogroup",
              "name": "question31",
              "title": "What is the highest level of education that you’ve completed?",
              "isRequired": true,
              "choices": [
               {
                "value": "1",
             ...
             },
             {
              "type": "radiogroup",
              "name": "question32",
              "title": "Do you have a long-lasting condition or identify as a person with a disability and/or as neuroatypical/neurodivergent?",
              "isRequired": true,
              "choices": [
               {
                "value": "1",
